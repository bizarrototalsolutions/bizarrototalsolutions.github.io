...
const NAV_ITEMS = [
  ...
  { page: 'perfil',        label: 'O Meu Perfil',   icon: 'fa-user',           href: 'perfil.html' }
];
  ...
  renderTopbar() {
    ...
    el.innerHTML = `
      ...
      <div class="bts-topbar-actions">
        ...
        <a class="bts-user-wrap" href="perfil.html" style="text-decoration:none;color:inherit" title="O meu perfil">
          <div class="bts-user-avatar">${user.avatarUrl ? `<img src="${Utils.escapeHtml(user.avatarUrl)}" alt="" style="width:100%;height:100%;border-radius:50%;object-fit:cover" />` : initials}</div>
