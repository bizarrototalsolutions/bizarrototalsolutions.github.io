...
const ServicosPage = {
  ...
  state: {
    ...
    sortDir: 'desc',
    search: '',
    filters: { estado: '', categoria: '', zonaId: '', funcionario: '', dataInicio: '', dataFim: '' }
  },
  ...
  bindEvents() {
    ...
    document.getElementById('limpar-filtros-servicos').addEventListener('click', () => {
      this.state.search = '';
      this.state.filters = { estado: '', categoria: '', zonaId: '', funcionario: '', dataInicio: '', dataFim: '' };
  ...
  aplicarFiltros() {
    this.state.filters = {
      ...
      zonaId: document.getElementById('filtro-zona-servico').value,
