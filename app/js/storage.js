...
function seedIfNeeded() {
  ...
  // NOTA: os utilizadores/credenciais já NÃO vivem aqui. A autenticação
  // é feita a sério contra o Supabase Auth (ver app/js/auth.js), por isso
  // não faz sentido (nem é seguro) semear uma password em texto simples
  // num ficheiro JS. DB.getUsers()/addUser() ficam disponíveis só como
  // API genérica de apoio ao backup (exportAll/importAll).
  lsSet(STORAGE_KEYS.USERS, []);
