...
(function () {
  ...
  var D = {
    ...
    'home.chips.elec': ['<span>RTIEBT</span><span>230/400 V</span><span>diferenciais</span><span>LED</span>', '<span>RTIEBT</span><span>230/400 V</span><span>RCDs</span><span>LED</span>', '<span>RTIEBT</span><span>230/400 V</span><span>diferenciales</span><span>LED</span>', '<span>RTIEBT</span><span>230/400 V</span><span>différentiels</span><span>LED</span>'],
    'home.chips.tel':  ['<span>Cat 6 / 6A</span><span>Fibra</span><span>CCTV</span><span>ITED · ITUR</span>', '<span>Cat 6 / 6A</span><span>Fibre</span><span>CCTV</span><span>ITED · ITUR</span>', '<span>Cat 6 / 6A</span><span>Fibra</span><span>CCTV</span><span>ITED · ITUR</span>', '<span>Cat 6 / 6A</span><span>Fibre</span><span>CCTV</span><span>ITED · ITUR</span>'],
    'home.chips.carp': ['<span>à medida</span><span>lacado</span><span>MDF / folha</span><span>exterior</span>', '<span>bespoke</span><span>lacquered</span><span>MDF / veneer</span><span>outdoor</span>', '<span>a medida</span><span>lacado</span><span>MDF / chapa</span><span>exterior</span>', '<span>sur mesure</span><span>laqué</span><span>MDF / placage</span><span>extérieur</span>'],
    'home.chips.domo': ['<span>HomeKit</span><span>Google</span><span>Alexa</span><span>cenários</span>', '<span>HomeKit</span><span>Google</span><span>Alexa</span><span>scenes</span>', '<span>HomeKit</span><span>Google</span><span>Alexa</span><span>escenas</span>', '<span>HomeKit</span><span>Google</span><span>Alexa</span><span>scénarios</span>'],
