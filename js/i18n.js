...
(function () {
  ...
  var D = {
    ...
    'svchub.why.list': ['<li>Um orçamento, um responsável, um número para ligar</li><li>As áreas falam entre si — a tomada fica onde o móvel a precisa</li><li>Menos dias de obra, menos marcações, menos "isso não é comigo"</li><li>Garantia sobre o conjunto, não sobre pedaços soltos</li>', '<li>One quote, one person in charge, one number to call</li><li>The trades talk to each other — the socket goes where the furniture needs it</li><li>Fewer days on site, fewer appointments, fewer "not my job"</li><li>Warranty on the whole, not on loose pieces</li>', '<li>Un presupuesto, un responsable, un número al que llamar</li><li>Los oficios hablan entre sí — el enchufe va donde lo necesita el mueble</li><li>Menos días de obra, menos citas, menos "eso no es lo mío"</li><li>Garantía sobre el conjunto, no sobre piezas sueltas</li>', '<li>Un devis, un responsable, un numéro à appeler</li><li>Les métiers se parlent — la prise est là où le meuble en a besoin</li><li>Moins de jours de chantier, moins de rendez-vous, moins de "ce n’est pas mon rayon"</li><li>Garantie sur l’ensemble, pas sur des morceaux isolés</li>'],
